...
def build_logout_url(id_token: Optional[str] = None, post_logout_redirect_uri: Optional[str] = None) -> str:
    """Build OIDC logout URL."""
    import urllib.parse

    params = {
        "post_logout_redirect_uri": post_logout_redirect_uri or f"{settings.frontend_url}/logout-callback"
    }
