...
async def initialize_database():
    """Initialize a database connection and enforce the configured schema policy."""
    ...
    try:
        ...
        logger.info("Database connection initialized; applying runtime schema policy...")
        await db_manager.initialize_runtime_schema()
        logger.info("Database schema policy completed")
